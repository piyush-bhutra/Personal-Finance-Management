...
const AnalyticsPage = ({ isEmbedded = false, onBack }) => {
  ...
  const investmentAllocation = useMemo(() => {
    ...
    activeInvestments.forEach((inv) => {
      ...
      allocation[type] =
        (allocation[type] || 0) + Number(inv.currentValue || inv.totalInvested);
    });
  ...
  const investmentPerformance = useMemo(() => {
    ...
    activeInvestments.forEach((inv) => {
      ...
      performance[type].currentValue += Number(
        inv.currentValue || inv.totalInvested || 0,
      );
    });
      ...
      >
        ...
        <Card className="border-border/50 shadow-sm bg-card/50 backdrop-blur-sm">
          <CardHeader>
            ...
            <CardDescription>
              Monthly spending trajectory over time
            </CardDescription>
          </CardHeader>
          <CardContent>
            {expenseTrends.length > 0 ? (
              <div className="mt-4 h-[280px] w-full sm:h-[350px]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <Card className="border-border/50 shadow-sm bg-card/50 backdrop-blur-sm">
            <CardHeader>
              ...
              <CardDescription>
                Current value distribution across active assets
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <Card className="border-border/50 shadow-sm bg-card/50 backdrop-blur-sm">
          <CardHeader>
            ...
            <CardDescription>
              Invested Principle vs Current Value
            </CardDescription>
          </CardHeader>
          <CardContent>
