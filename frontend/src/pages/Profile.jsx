          ...
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                  <div className="space-y-2">
                    ...
                    {isEditing ? (
                      ...
                      <p className="text-base font-medium bg-secondary/30 px-3 py-2 rounded-md border border-border/50">
                        {user.name}
                      </p>
                    )}
                    <p className="text-xs text-muted-foreground mt-1">
                      This is how you appear internally.
                    </p>
                  </div>
                  <div className="space-y-2">
                    <p className="text-sm text-muted-foreground font-medium uppercase tracking-wider">
                  ...
                  <div className="space-y-1 md:col-span-2">
                    ...
                    <p className="text-base font-medium bg-secondary/30 px-3 py-2 rounded-md border border-border/50 md:w-[calc(50%-12px)] opacity-80 cursor-not-allowed">
                      {memberSinceStr}
                    </p>
                  </div>
                </div>
            ...
            <Card className="border-border/50 shadow-sm">
              <CardHeader className="px-6 sm:px-10 pt-8">
                ...
                <CardDescription>
                  An overview of your tracked data.
                </CardDescription>
              </CardHeader>
              <CardContent className="px-6 sm:px-10 pb-8">
                {loading ? (
                  ...
                  <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div className="bg-accent/10 border border-accent/30 p-4 rounded-xl flex flex-col gap-1">
                      <span className="text-accent/80 text-sm flex items-center gap-2">
                        Active
                      </span>
          ...
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
            <Card className="border-border/50 shadow-sm">
              <CardHeader className="px-6 sm:px-10 pt-8">
                ...
                <CardDescription>
                  Your localized settings and preferences.
                </CardDescription>
              </CardHeader>
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-4 bg-secondary/20 border border-border/50 rounded-xl gap-4">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      The primary currency applied to your portfolio.
                    </p>
                  </div>
